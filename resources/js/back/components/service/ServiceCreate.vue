                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm" name="service_type_id" required>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" class="form-control form-control-sm" name="date">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label><b>Amount *</b></label>
                                <input type="number" step="any" class="form-control form-control-sm" name="amount" required>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="add_type" class="form-control form-control-sm" required>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="short_description" cols="30" rows="3" required></textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label><b>Description</b></label>
                                <textarea id="editor" class="form-control" name="description" cols="30" rows="3" required></textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
...
export default {
    ...
    methods:{
        ...
        async submitForm(){
            ...
            await axios.post(`${this.app_url}/adminx/service/store`,data).then((response)=>{
