        ...
        <div class="container-fluid">
            ...
            <div class="row project-wrapper">
                <div class="col-xxl-12">
                    <!-- Create form start -->
                    <form action="{{ route('back.service.update', $service->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="row">
                            <div class="col-lg-8">
                            ...
                            <div class="col-lg-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="img_group">
                                            <img class="img-thumbnail uploaded_img" src="{{$service->img_paths['small']}}">
                                            <br>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="position" name="position"
                                                value="{{ old('position') ?? $service->position }}" required>
                                        </div>
