                            ...
                            <div class="col-lg-8">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title mb-0 flex-grow-1">Edit Testimonial</h4>
                                    </div>
                                    <div class="card-body">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="editor" placeholder="Enter the Message"
                                                        name="message">{{ old('message') ?? $testimonial->message }}</textarea>
                                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="phone" name="phone"
                                                value="{{ old('phone') ?? $testimonial->phone }}" required>
                                        </div>
                                        <br>
                                        <div class="form-group">
