                ...
                <div class="card border-light mt-3 shadow">
                    <div class="blog-table-header card-header">
                        ...
                        <ul class="list-inline">
                            <li class="list-inline-item"> <a href="{{ route('back.news.categories') }}" class="btn btn-info float-right"><i class="ri-add-circle-line"></i> Create</a></li>
                        </ul>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="for" value="newsevent">
