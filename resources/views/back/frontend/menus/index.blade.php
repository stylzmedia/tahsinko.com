                            ...
                            <div class="accordion accordionFrontMenu" id="accordionFrontMenu">
                                <div class="card">
                                  <div class="card-header" id="headingOne">
                                    <h2 class="mb-0">
                                      <a class="btn btn-block text-left" data-bs-toggle="collapse" href="#collapseFMPages" role="button" aria-expanded="true" aria-controls="collapseFMPages">
                                        <b>Pages</b>
                                      </a>
                                    </h2>
                                  </div>
                                  ...
                                  <div id="collapseFMPages" class="collapse show" aria-labelledby="headingFMPages" data-parent="#accordionFrontMenu">
                                    <form action="{{route('back.menus.storeMenuItem')}}" method="POST">
                                        ...
                                        <div class="card-footer">
                                            <button class="btn btn-success">Add to Menu <i class="ri-arrow-right-line"></i></button>
                                        </div>
                                    </form>
                                  </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingFMCustom">
                                        <h2 class="mb-0">
                                            <a class="btn btn-block text-left" data-bs-toggle="collapse" href="#collapseFMCustom" role="button" aria-expanded="true" aria-controls="collapseFMCustom">
                                                <b>Custom Link</b>
                                            </a>
                                        </h2>
                                    </div>
                                    ...
                                    <div id="collapseFMCustom" class="collapse" aria-labelledby="headingFMCustom" data-parent="#accordionFrontMenu">
                                      <form action="{{route('back.menus.storeMenuItem')}}" method="POST">
                                            ...
                                            <div class="card-footer">
                                                <button class="btn btn-success">Add to Menu <i class="fas fa-arrow-right"></i></button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                        ...
                        <form action="{{route('back.menus.menuItemPosition')}}" method="POST">
                                        ...
                                        <ol class="dd-list">
                                            @foreach ($menu_items as $menu_item)
                                                <li class="dd-item" data-id="{{$menu_item->id}}">
                                                    ...
                                                    <span class="text-success edit_item_btn" data-id="{{$menu_item->id}}"><i class="ri-edit-2-line"></i></span>
                                                    @endif

                                                    <a href="{{route('back.menus.destroyItem', $menu_item->id)}}" onclick="return confirm('Are you sure to remove?');"><i class="ri-delete-bin-5-line float-right"></i></a>
                            ...
                            @if(request('menu'))
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-6">
                                            <a href="{{route('back.menus.destroy', $menu->id)}}" onclick="return confirm('Are you sure to remove?');" class="btn btn-danger">Delete</a>
                                        </div>
