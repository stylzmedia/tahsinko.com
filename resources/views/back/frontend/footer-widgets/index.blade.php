        ...
        <div class="row">
                            ...
                            <tbody>
                                @foreach ($widgets as $key => $widget)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary btn-sm" href="{{route('back.footer-widgets.edit', $widget->id)}}"><i class="ri-edit-2-line"></i></a>
            ...
            <div class="col-md-4">
                <div class="card border-light mt-3 shadow">
                    ...
                    <form action="{{route('back.footer-widgets.index')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" name="position" value="{{old('position')}}" required>
                                            </div>
                                        </div>
                                    </div>
                                    <br>
